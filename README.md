...
See [`proof.html`](proof.html) for the mathematical write-up (MathJax, dark mode),
and [`README-ja.md`](README-ja.md) for Japanese.
...
| `proof.html` | Human-readable mathematical proof. |
